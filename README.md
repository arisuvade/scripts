[boot-bios.sh](https://github.com/arisuvade/scripts/blob/main/bios-boot.sh): Automatically access the BIOS after boot to disable secure boot due to a dead CMOS battery.
